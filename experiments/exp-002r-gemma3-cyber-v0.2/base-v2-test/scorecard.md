# Scorecard — base-v2-test

- **Model:** `mlx-community/gemma-3-4b-it-4bit`
- **Timestamp (UTC):** 2026-08-27T17:23:38.686123+00:00
- **Benchmark:** `data/evaluation/benchmark_v2.jsonl` (45 items)
- **Settings:** temp=0.0, seed=0, num_predict=512
- **Duration:** 153.7s

## Overall: pass_rate = **0.933**, mean_score = **0.826** (n=45)
...
| detection_engineering | 3 | 1.0 | 0.833 |
| evidence_interpretation | 3 | 1.0 | 1.0 |
| fundamentals | 3 | 1.0 | 0.917 |
| hallucination | 3 | 0.333 | 0.333 |
| incident_response | 3 | 1.0 | 0.667 |
| insufficient_evidence | 3 | 0.667 | 0.667 |
| log_analysis | 3 | 1.0 | 0.75 |
| network | 3 | 1.0 | 1.0 |
| privilege_escalation | 3 | 1.0 | 0.806 |
| vulnerability_analysis | 2 | 1.0 | 0.834 |
| web_security | 3 | 1.0 | 0.833 |
...
| fund-0105 | fundamentals | keyword | ✅ | 0.75 | matched 3/4: ['authentication', 'identity', 'authorization'] |
...
| det-0103 | detection_engineering | keyword | ✅ | 0.5 | matched 2/4: ['false positive', 'context'] |
...
| privesc-0106 | privilege_escalation | keyword | ✅ | 0.667 | matched 2/3: ['setuid', 'capabilit'] |
