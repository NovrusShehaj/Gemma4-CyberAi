...
| ctf_reasoning | 1 | 1.0 | 0.667 |
| detection_engineering | 2 | 0.5 | 0.5 |
| evidence_interpretation | 1 | 0.0 | 0.333 |
| fundamentals | 4 | 1.0 | 1.0 |
| hallucination | 2 | 0.0 | 0.0 |
| incident_response | 1 | 1.0 | 0.667 |
| insufficient_evidence | 2 | 1.0 | 1.0 |
| log_analysis | 2 | 1.0 | 1.0 |
| network | 3 | 1.0 | 0.889 |
...
| log-0002 | log_analysis | mcq | ✅ | 1.0 | chose=B expected=B |
| log-0003 | evidence_interpretation | keyword | ❌ | 0.333 | matched 1/3: ['location'] |
| ir-0001 | incident_response | keyword | ✅ | 0.667 | matched 2/3: ['isolate', 'memory'] |
...
| ctf-0001 | ctf_reasoning | keyword | ✅ | 0.667 | matched 2/3: ['extension', 'shell'] |
